/**
 * Privacy-filtered DB queries for patient-facing clinical data.
 * Only the columns approved in src/agent/privacy.ts are selected — never doctor-only fields.
 */
...
// ── Patient-facing queries (only safe columns selected) ───────────────────────
